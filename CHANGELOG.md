...
- **Fast Reasoning AI Engine**: Multi-provider fallback router (Gemini 1.5 Flash / Pollinations Fast Reasoning / Groq) with smart conciseness formatting (concise by default, detailed on demand).
...
- **AWS SSH Deployment & Docker Engine**: Automated deployment to AWS host `98.89.32.42` (`https://98.89.32.42.nip.io`).
